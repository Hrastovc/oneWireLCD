...
class oneWireLCD : public Print {
public:
  oneWireLCD(uint8_t pin);
  oneWireLCD(uint8_t pin,
             uint8_t rs_pin, uint8_t enable_pin, uint8_t D4,
             uint8_t D5, uint8_t D6, uint8_t D7, uint8_t backlight_pin);
  oneWireLCD(uint8_t clockPin, uint8_t dataPin, uint8_t latchPin);
  oneWireLCD(uint8_t clockPin, uint8_t dataPin, uint8_t latchPin,
             uint8_t rs_pin, uint8_t enable_pin, uint8_t D4,
             uint8_t D5, uint8_t D6, uint8_t D7, uint8_t backlight_pin);
...
private:
  ...
  void pulseEnable();
  void MODdigitalWrite(uint8_t pin, uint8_t state);
